...
if __name__ == "__main__":
    ...
    set_velx(80,50)  # set global task speed: 30(mm/sec), 20(deg/sec)
    set_accx(100,70)  # set global task accel: 60(mm/sec2), 40(deg/sec2)

    velx=[50, 50]
    accx=[100, 100]

    p1= posj(0,0,0,0,0,0)                    #joint
    p2= posj(0.0, 45.0, 90.0, 45.0, 90.0, 0.0) #joint

    x1= posx(500, 550, 750.0, 0.0, 180.0, 0.0) #task position,end effector
    x2= posx(500, 550, 350.0, 0.0, 90.0, 0.0) #task 

    c1 = posx(559,434.5,650,0,180,0) # define the path the robot follows , x and y the same
    c2 = posx(559,434.5,250,0,180,0)


    q0 = posj(0,0,0,0,0,0) #initial position of joints
    q1 = posj(15, -10, 30, -20, 15, 25)
    q2 = posj(20, -15, 35, -25, 20, 30) 
    q3 = posj(25, 0, 40, -30, 25, 35) 
    q4 = posj(30, 5, 45, -35, 30, 40)
    q5 = posj(35, 10, 50, -40, 35, 45)
